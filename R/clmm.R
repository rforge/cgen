...
clmm <- function(y, X = NULL , random = NULL, par_random = NULL , par_mcmc = NULL, niter=10000, burnin=5000,scale_e=0,df_e=-2, verbose = FALSE, seed = NULL){
...
set.seed(seed)
#cat(paste("\n seed: ",seed,"\n",sep="")) 
 .Call("clmm",y, X , par_fixed ,random, par_random ,par_mcmc, verbose=verbose, options()$cgen.threads, PACKAGE = "cgen" )[[1]]
...
clmm.CV <- function(y, X = NULL , random = NULL, par_random = NULL , par_mcmc = NULL, niter=10000, burnin=5000,scale_e=0,df_e=-2, verbose = FALSE, seed = NULL){
...
set.seed(seed)
#cat(paste("\n seed: ",seed,"\n",sep="")) 
.Call("clmm",y, X , par_fixed ,random, par_random ,par_mcmc, verbose=verbose, options()$cgen.threads, PACKAGE = "cgen" )
...
cGBLUP <- function(y,A,X=NULL,scale_a = 0, df_a = -2, scale_e = 0, df_e = -2, niter = 10000, burnin = 5000, seed = NULL, verbose=FALSE){
...
if(length(isy) < length(y)) { u[-isy] <- A[-isy,isy] %c% csolve(A[isy,isy],u[isy]) }
