...
#	 .Call( "cGWAS", y[isy], M[isy,], V[isy,isy], X[isy,], dom, sparse, threads, PACKAGE = "cgen" )
gwa <- .Call( "cGWAS", y, M, V, V2, X, dom, second_transform, sparse, verbose, options()$cgen.threads, PACKAGE = "cgen" )
...
if(verbose) cat(paste("\nVariance Components:\nMarker: ",round(s2a,dig=3),"\nResidual: ",round(s2e,dig=3),"\n",sep=""))
...
gwa<- .Call( "cGWAS", Uy, M, V, t(UD$vectors), UX, dom, second_transform, sparse,verbose, options()$cgen.threads, PACKAGE = "cgen" )
